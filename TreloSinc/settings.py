"""
Django settings for TreloSinc project.
...
SECRET_KEY = 'n&v)-fautqum2n7z^&r*j!nxopd*j@7=9npsm7+$9_@ecxye5c'
...
WSGI_APPLICATION = 'TreloSinc.wsgi.application'
